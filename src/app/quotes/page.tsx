      ...
      <SectionCard title="Liste devis">
        ...
        <div className="space-y-3 lg:hidden">
          {quotes.length === 0 ? (
            ...
            quotes.map((quote) => (
              <div key={quote.id} className="rounded-2xl border bg-white p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    <div className="truncate text-sm text-muted-foreground">Devis</div>
                    <div className="truncate text-base font-semibold">{quote.number}</div>
                  ...
                  <Badge variant={statusVariant[quote.status] || 'secondary'} className="shrink-0">
                    {quote.status}
                  </Badge>
                </div>
                ...
                <div className="mt-3 flex items-center justify-between gap-3">
                  <div className="truncate text-xs text-muted-foreground">
                    {JOB_TYPE_LABELS[quote.job_type]} - {formatDate(quote.issue_date)}
                  </div>
