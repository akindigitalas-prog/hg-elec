...
import { addQuoteFreeLine, addQuoteItemFromProduct, type QuoteItemState } from './actions';
...
export function QuoteItemsForm({
  ...
  const qtyFreeId = `${baseId}-qty-free`;
  const [productState, productAction] = useFormState(
    addQuoteItemFromProduct.bind(null, quoteId),
    initialState
  );
  const [freeState, freeAction] = useFormState(
    addQuoteFreeLine.bind(null, quoteId),
    initialState
  );
        ...
        <DialogContent>
          ...
          <form ref={freeFormRef} action={freeAction} className="space-y-3">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <div className="space-y-2">
                <Label htmlFor={qtyFreeId}>Quantite</Label>
                <Input
                  id={qtyFreeId}
                  name="qty"
                  type="number"
